...
YouCan = true
elseif tonumber(senderr) == tonumber(5822509401) then
YouCan = true
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله مالكاساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Fast.."SuperCreator:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله مالكاساسي ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله مالكاساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Fast.."SuperCreator:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله مالكاساسي ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله مالكاساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Fast.."SuperCreator:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله مالكاساسي ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مالكاساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."SuperCreator:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مالكاساسي ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ" then
if not msg.SuperCreator then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم ترقيته مالكاساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."SuperCreator:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم ترقيته مالكاساسي ").Reply,"md",true)  
end
end
if TextMsg == "منشئ" then
if not msg.SuperCreator then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه سمب في القروب عقبال ميبقا زي النسوان الي تعبينو 😂  ").Reply,"md",true)  
end
end
if TextMsg == "قرد" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه قرد في القروب تعال خدلك موزه  😂  ").Reply,"md",true)  
end
end
if TextMsg == "عره" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه عره في القروب قولو عيب كده 😂  ").Reply,"md",true)  
end
end
if TextMsg == "غبي" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مالكاساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."SuperCreator:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مالكاساسي ").Reply,"md",true)  
end
end
if UserId[1] == "منشئ" then
if not msg.SuperCreator then
...
elseif text and text:match("^تغيير رد المالكالاساسي (.*)$") then
if not msg.Manger then
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
end
local Teext = text:match("^تغيير رد المالكالاساسي (.*)$") 
Redis:set(Fast.."President:Group:Reply"..msg.chat_id,Teext)
return send(msg_chat_id,msg_id,"• تم تغيير رد المالكالاساسي الى :"..Teext)
elseif text and text:match("^تغيير رد المالك(.*)$") then
if not msg.Manger then
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
end
...
return send(msg_chat_id,msg_id,"• تم تغيير رد المالكالى :"..Teext)
...
elseif text == 'مسح رد المالكالاساسي' then
if not msg.Manger then
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
end
Redis:del(Fast.."President:Group:Reply"..msg.chat_id)
return send(msg_chat_id,msg_id,"• تم مسح رد المالكالاساسي ")
...
if statusvar == false then
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(5)..' , مالك القروب }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
StatusMemberChat = 'عضو في القروب'
end
