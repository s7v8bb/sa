...
if UserId ==5822509401 then
Status = true
elseif UserId ==5822509401 then
Status = true
elseif UserId ==5822509401 then  
Status = true
...
elseif Ownerss then
Status = Redis:get(Fast..'SetRt'..ChatId..':'..UserId) or Redis:get(Fast.."PresidentQ:Group:Reply"..ChatId) or  'المــالك 🌟'
elseif SuperCreator then
Status = Redis:get(Fast..'SetRt'..ChatId..':'..UserId) or Redis:get(Fast.."President:Group:Reply"..ChatId) or 'المالك الاساسي 🌟'
elseif Creator then
Status = Redis:get(Fast..'SetRt'..ChatId..':'..UserId) or Redis:get(Fast.."Constructor:Group:Reply"..ChatId) or 'المالك 🌟'
elseif Manger then
...
Status = Redis:get(Fast..'SetRt'..ChatId..':'..UserId) or 'مالك القروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = Redis:get(Fast..'SetRt'..ChatId..':'..UserId) or 'مشرف القروب'
elseif Special then
...
{
{text = '- مالك اساسي : '..SuperCreatorz, data =user..'/statusSuperCreatorz/'..useri},{text = '- مالك : '..Creatorz, data =user..'/statusCreatorz/'..useri},
},
{
...
UserInfousername = '['..UserInfo.first_name..'](t.me/s_7v8'..UserInfo.username..')'
else
...
if tonumber(senderr) ==5822509401 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) ==5822509401 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) ==5822509401 then
msg.Name_Controller = 'مطـور السـورس  '
...
msg.Name_Controller = Redis:get(Fast..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(Fast.."President:Group:Reply"..msg.chat_id) or 'المالك الاساسي 🌟'
elseif Redis:sismember(Fast.."Creator:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Fast..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(Fast.."Constructor:Group:Reply"..msg.chat_id) or 'المالك 🌟 '
...
Welcome = Welcome:gsub('{القروب}',(Get_Chat.title or '---')) 
...
GroupsWelcome = GroupsWelcome:gsub('{القروب}',(Get_Chat.title or '---')) 
...
if type == "kick" then 
return bot.setChatMemberStatus(msg.chat_id,msg.sender_id.user_id,'banned',0), send(msg_chat_id,msg_id,Reply_Status(msg.sender_id.user_id,"• قام بالتكرار في القروب وتم طرده").Reply,"md",true)
end
if type == "del" then 
return bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if type == "keed" then
return bot.setChatMemberStatus(msg.chat_id,msg.sender_id.user_id,'restricted',{1,0,0,0,0,0,0,0,0}), send(msg_chat_id,msg_id,Reply_Status(msg.sender_id.user_id,"• قام بالتكرار في القروب وتم تقييده").Reply,"md",true)  
end
if type == "mute" then
Redis:sadd(Fast.."SilentGroup:Group"..msg.chat_id,tonumber(msg.sender_id.user_id)) 
return send(msg_chat_id,msg_id,Reply_Status(msg.sender_id.user_id,"• قام بالتكرار في القروب وتم كتمه").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,"• لا استطيع تغيير صورة القروب لاني لست ادمن او ليست لديه الصلاحيه ","md",true)    
end
Redis:del(Fast.."Chat:Photo"..msg_chat_id..":"..msg.sender_id.user_id)
return send(msg_chat_id,msg_id,"• تم تغيير صورة القروب بنـجاح ","md",true)    
end
...
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/s_7v8joinchat/%S+)") then     
local LinkGroup = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/s_7v8joinchat/%S+)")   
...
send(msg_chat_id,msg_id,'• لا يوجد صوتيه بهذا الاسم في القروب')
Redis:del(Fast.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return false
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'All:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/s_7v8'..Redis:get(Fast..'All:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'All:Channel:Join:Name'), url = 't.me/s_7v8'..Redis:get(Fast..'All:Channel:Join')}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/s_7v8'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Channel:Join:Name'), url = 't.me/s_7v8'..Redis:get(Fast..'Channel:Join')}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'• عدد الاعضاء قليل لا يمكن تفعيل القروب  يجب ان يكون اكثر من :'..Redis:get(Fast..'Num:Add:Bot'),"md",true)  
end
...
return send(msg_chat_id,msg_id,"\n*• عذرآ القروب محظوره من التفعيل *","md",true)  
end
...
{
{text = 'قناة السورس', url='http://t.me/s_7v8'..chsource..''},
},
}
...
local StatusMember = bot.getChatMember(msg_chat_id,senderr).status.Fastbots
if (StatusMember == "chatMemberStatusCreator") then
return send(msg_chat_id,msg_id,"• الصلاحيات : مالك القروب","md",true) 
elseif (StatusMember == "chatMemberStatusAdministrator") then
StatusMemberChat = 'مشرف القروب'
else
return send(msg_chat_id,msg_id,"• الصلاحيات : عضو في القروب" ,"md",true) 
end
...
return send(msg_chat_id,msg_id,"• الصلاحيات : مشرف القروب"..(PermissionsUserr or '') ,"md",true) 
end
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{
{text = '- مالك اساسي : '..SuperCreatorz, data =senderr..'/statusSuperCreatorz/'..UserId_Info.id},{text = '- مالك : '..Creatorz, data =senderr..'/statusCreatorz/'..UserId_Info.id},
},
{
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{
{text = '- مالك اساسي : '..SuperCreatorz, data =senderr..'/statusSuperCreatorz/'..rep_idd},{text = '- مالك : '..Creatorz, data =senderr..'/statusCreatorz/'..rep_idd},
},
{
...
data = {
{
{text = 'Dev', url = 't.me/s_7v8Yousef_Labban'}, 
},
}
}
...
if text == 'مصنع السورس' or text == 'المصنع' or text == 'مصنع'  then
  ...
  data = {
  {
  {text = 'Source FREE', url = 'https://t.me/s_7v8Yousef_Labban1'}, 
  },
  }
  }
  return send(msg_chat_id,msg_id,"[Source FREE](https://t.me/s_7v8Yousef_Labban1)","md",true, false, false, true, reply_markup)
  end
if text == "صورتي" then
...
return send(msg_chat_id,msg_id,"• تم ازالة قوانين القروب","md",true)    
end
...
return send(msg_chat_id,msg_id,"• ارسل لي وصف القروب الان","md",true)  
end
...
{
{text = '- تغيير معلومات القروب : '..info, data =senderr..  '/info'}, 
},
{
...
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(8)..' , مالك القروب }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/s_7v8'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'\n*• تم تنزيل جميع رتب القروب { المالكين الاساسسين , المالكين , المدراء , الادمنيه  }* ',"md",true)  
end
...
if text == 'تفاعل القروب' and msg.reply_to_message_id == 0 then
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/s_7v8'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,"• تفاعل القروب : "..MsgText, "md")
end
...
if statusvar == false then
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(3)..' , مالك القروب }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/s_7v8'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• لا يوجد مالكين اساسيين حاليا , ","md",true)  
end
Redis:del(Fast.."SuperCreator:Group"..msg_chat_id) 
...
if #list == 0 then
text = "• عذرا لا يوجد ردود مضافه في القروب"
end
...
return send(msg_chat_id,msg_id,'\n*⌯ هذا الامر يخص { مالك المجموعه او رتبه المالك }* ',"md",true)
end
local list = Redis:smembers(Fast..":My_Rd:text:"..msg.chat_id)
for k,v in pairs(list) do
...
data = {
{
{text = UserInfo.first_name , url = "t.me/s_7v8"..(UserInfo.username or UserBot)},
},
}
}
if photo.total_count > 0 then
...
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/s_7v8uui9u'}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/s_7v8'}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
{
{text = 'مطور السورس', url = 'hsttp://t.me/s_7v8'..devsource},
},
}
}
...
data = {
{
{text = 'اضغط هنا لارسال الهمسه', url = 't.me/s_7v8'..UserBot..'?start=hms'..testhms..'from_id'..msg.sender_id.user_id}, 
},
}
}
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/s_7v8L1BBBL/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendanimation?chat_id=' .. msg.chat_id .. '&animation=https://t.me/s_7v8GifWaTaN/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/s_7v8MemzWaTaN/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/s_7v8RemixWaTaN/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/s_7v8PhotosWaTaN/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/s_7v8AnimeWaTaN/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/s_7v8MoviesWaTaN/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/s_7v8SeriesWaTaN/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
...
local MSGID = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/s_7v8TEAMSUL/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MSGID.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
end
...
local MsgId = msg.id/2097152/0.5
local MSGID = 0
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/s_7v8meromp3/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MSGID.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
end 
...
local datar = {data = {{text = "قناة السورس" , url = 'http://t.me/s_7v8'..chsource..''}}}
if #json < 5 then
for i = 1,#json do
title = json[i].title
...
data = {
{
{text = 'الشروحات', url = 't.me/s_7v8Yousef_Labban1'..devsource},{text = 'لتنصيب بوت', url = 't.me/s_7v8Yousef_Labban'..devsource2},  
},
{
{text = 'سورس مجاني', url = 'http://t.me/s_7v8Yousef_Labban1'..chsource..''}, 
},
{
},
}
}
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/s_7v8'..chsource..'', [[
🅢🅞🅤🅡🅒🅔 🅒🅞🅑🅡🅐 
...
if Redis:get(Fast.."name bot type : ") == "photo" then
  ...
  local reply_markup = bot.replyMarkup{type = 'inline',data = {
    {
      {text = Name_User, url = "t.me/s_7v8"..UserInfo.username}
    },
    {
      {text = Name_dev, url = "t.me/s_7v8"..UName_dev }
    }
  }
  }
...
x = x + 1
send(Get_Chat.id,0,'*• البوت عضو في القروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
...
{
{text="المالكين",data=senderr..'/Ownerss'},{text="المالكين الاساسيين",data=senderr..'/SuperCreator'},
},
{
{text="المالكين",data=senderr..'/Creator'},{text="المدراء",data=senderr..'/Manger'},
},
{
...
if text == ("الرتب المضافه") then
  ...
  if ChannelJoin(msg) == false then
  local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/s_7v8XB_35 '}, },}}
  return send(msg.chat_id,msg.id,'*\n⌔عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
  end
...
elseif rtba_type == "acreator" then rtba_t = "مالك اساسي"
elseif rtba_type == "creator" then rtba_t = "مالك"
...
if text and Redis:get(Fast.."Set:rtba"..senderr..":"..msg_chat_id) == "true" then
  ...
  data = {
    ...
    {{text = 'مالك', data = senderr..'/promot_creator/'..text}},
    {{text = 'مالك اساسي', data = senderr..'/promot_acreator/'..text}},
...
Redis:set(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع مالك')
Redis:set(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع مالك اساسي')
...
Redis:set(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تنز','تنزيل الكل')
...
local listA = {'تعطيل الايدي بالصورة','تفعيل الايدي بالصورة','ايدي','رفع مميز', 'رفع ادمن','رفع مدير', 'رفع مالك', 'رفع مالك اساسي','رفع مطور','تنزيل الكل','الرابط','الردود','مسح المكتومين','اضف رد','غنيلي','رسائلي','رفع مطور ثانوي','مسح تعديلاتي','نقاطي','اسالني','لغز','معاني','حزوره','رفع القيود','الغاء حظر','تثبيت','كشف','تاك','تاك للكل','تغيير الايدي','تنزيل الكل','قفل الاشعارات','فتح الاشعارات','مسح رد','اضف امر'}
...
Redis:del(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع مالك')
Redis:del(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع مالك اساسي')
...
Redis:del(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تنزل','تنزيل الكل')
...
'\n• ارفعه ادمن {مشرف}'..
'\n• ارسل كلمة { تفعيل } ليتم تفعيل القروب'..حقوق سورس @s_7v8
'\n• مطور البوت ← {@'..UserSudo..'}*'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = '➕ اضفني لمجموعتك', url = 't.me/s_7v8'..UserBot..'?startgroup=new'}, 
},
{
{text = 'قناة السورس', url = 'http://t.me/s_7v8'..chsource..''}, 
},
