...
return send(msg_chat_id,msg_id,"• تم تعطيل الايدي بالصورة ","md",true)
end
...
return send(msg_chat_id,msg_id,"• تم تعطيل الردود العامة ","md",true)
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم حظره من  القروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم حظره من  القروب ").Reply,"md",true)  
end
end
...
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء حظره من  القروب  ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم كتمه في  القروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم كتمه في  القروب  ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه من  القروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تقييده في  القروب \n• لمدة : "..UserName[1]..' '..UserName[2]).Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تقييده في  القروب \n• لمدة : "..TimeKed[1]..' '..TimeKed[2]).Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تقييده في  القروب ").Reply,"md",true)  
end
...
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم طرده من  القروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم حظره من  القروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."BanGroup:Group"..msg_chat_id,rep_idd) 
bot.setChatMemberStatus(msg.chat_id,rep_idd,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم حظره من  القروب ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم الغاء حظره من  القروب  ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم كتمه في  القروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."SilentGroup:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم كتمه في  القروب  ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم الغاء كتمه من  القروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تقييده في  القروب ").Reply,"md",true)  
end
...
bot.setChatMemberStatus(msg.chat_id,rep_idd,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم طرده من  القروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم حظره من  القروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."BanGroup:Group"..msg_chat_id,UserId) 
bot.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم حظره من  القروب ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء حظره من  القروب  ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم كتمه في  القروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."SilentGroup:Group"..msg_chat_id,UserId) 
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم كتمه في  القروب  ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه من  القروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تقييده في  القروب ").Reply,"md",true)  
end
...
bot.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم طرده من  القروب ").Reply,"md",true)  
end
...
if KickMe == true then
return send(msg_chat_id,msg_id,"*• عذرا لا استطيع طرد ادامن ومنشئين الجروب*","md",true)    
end
bot.setChatMemberStatus(msg.chat_id,senderr,'restricted',{1,1,1,1,1,1,1,1,1})
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم طردك من  القروب بنائآ على طلبك").Reply,"md",true)  
end

if text == 'ادامن الجروب' or text == 'المشرفين' then
if not msg.Manger then
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
File:write(Get_Json)
File:close()
return bot.sendDocument(msg_chat_id,msg_id,'./'..UserBot..'.json', '*• تم جلب النسخة الاحتياطية\n• تحتوي على {'..#Groups..'} جروب \n• وتحتوي على {'..#UsersBot..'} مشترك *\n', 'md')
end
if text == 'تفعيل جلب النسخة التلقائية' then   
if not msg.Devss then
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(2)..' }* ',"md",true)  
end
Redis:setex(Fast.."Status:SendFile",43200,true) 
return send(msg_chat_id,msg_id,"⌯︙تم تفعيل جلب نسخة الجروبات التلقائية","md")
end
if text == 'تعطيل جلب النسخة التلقائية' then   
if not msg.Devss then
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(2)..' }* ',"md",true)  
end
Redis:del(Fast.."Status:SendFile") 
return send(msg_chat_id,msg_id,"⌯︙تم تعطيل جلب نسخة الجروبات التلقائية","md")
end
...
File:write(Get_Json)
File:close()
bot.sendDocument(Sudo_Id,0,'./'..UserBot..'.json', '*• تم جلب النسخة الاحتياطية\n• تحتوي على {'..#Groups..'} جروب \n• وتحتوي على {'..#UsersBot..'} مشترك *\n', 'md')
local Get_Json = '{"BotId": '..Fast..','  
Get_Json = Get_Json..'"GroupsBotreply":{'
...
if text == 'جلب الردود العامة' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Get_Json = '{"BotId": '..Fast..','  
...
if text == 'رفع الردود العامة' and msg.reply_to_message_id ~= 0 then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return send(msg_chat_id,msg_id,'\n*• تم استرجاع ردود العامة* ',"md",true)  
end
end
...
if text == "تعطيل منع التصفية" then
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'• تم تعطيل منع التصفية مسبقا\n ✓',"md")
else
Redis:set(Fast.."spammkick"..msg.chat_id,"true")
return send(msg_chat_id,msg_id,'• تم تعطيل منع التصفية\n ✓',"md")
end
end
if text == "تفعيل منع التصفية" then
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'• تم تفعيل منع التصفية مسبقا\n ✓',"md")
else
Redis:del(Fast.."spammkick"..msg.chat_id)
return send(msg_chat_id,msg_id,'• تم تفعيل منع التصفية\n ✓',"md")
end
end
