...
xname =  (Redis:get(Fast.."Name:Bot") or " سعيد") 
...
data = {
{
{text = '❍ 𓏶 creative • 𝒔𝒐𝒖𝒓𝒄?? 𓏶 ❍', url = 't.me/  s_7v8'}, 
},
}
}
return send(msg_chat_id,msg_id,'*نزل عينك تحت كدا علشان هتخاد علي قفاك 😒❤️*',"md",false, false, false, false, reply_markup)
...
data = {
{
{text = '❍ 𓏶 𝒄𝒓??𝒔𝒕𝒊𝒏 • 𝒔𝒐𝒖𝒓𝒄𝒆 𓏶 ❍', url = 't.me/  s_7v8'}, 
},
}
}
...
data = {
{
{text = '❍ 𓏶 creative • 𝒔𝒐𝒖𝒓??𝒆 𓏶 ❍', url = 't.me/  s_7v8'}, 
},
}
}
...
data = {
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗖𝗢𝗕𝗥𝗮', url = 't.me/  s_7v8'}, 
},
}
}
